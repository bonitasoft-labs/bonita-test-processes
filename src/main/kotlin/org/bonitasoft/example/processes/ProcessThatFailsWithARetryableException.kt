...
class ProcessThatFailsWithARetryableException : BonitaProcess() {
        ...
        return ProcessDefinitionBuilder().createNewInstance(this.javaClass.simpleName, "1.0")
                .apply {
                    ...
                    addAutomaticTask("automatic task that fails")
                            .addDisplayName("throw new java.sql.SQLTransientException('Exception that can be retried')".toScript())
                }
    }
}
